...
- When developing with AndroidStudio, the adapter version number should be consistent with the main package version number of the corn SDK. To add such, Adapter, for example, you use the corn SDK for version 5.0.0 "com.yumimobi.ads:mediation:5.0.0", you need to add such Adapter 5.0.0 version "com.yumimobi.ads.mediation:such:5.0.0"
...
```c
dependencies {
   implementation 'com.yumimobi.ads.mediation:iqzone:5.0.0'
}
```
