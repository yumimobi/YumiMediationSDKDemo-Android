...
- When developing with AndroidStudio, the adapter version number should be consistent with the main package version number of the corn SDK. To add such, Adapter, for example, you use the corn SDK for version 4.5.1 "com.yumimobi.ads:mediation:4.5.1", you need to add such Adapter 4.5.1 version "com.yumimobi.ads.mediation:such:4.5.1"
