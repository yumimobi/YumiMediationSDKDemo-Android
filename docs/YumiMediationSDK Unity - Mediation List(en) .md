...
|                   |                                                              |
| ----------------- | ------------------------------------------------------------ |
| Jar Name          | libs/yumi_adapter_mintegral.jar (GooglePlay release or release outside China market channel) <br /> libs/yumi_adapter_mintegral_v3.3.9_China.jar (China market channel release)|
| Provider Ver      | 8.13.0                                                        |
| GooglePlayService | --                                                           |
| Ad Form           | Reward Video                                                 |
...
|                   |                             |
| ----------------- | --------------------------- |
| Jar Name          | libs/yumi_adapter_unity.jar (GooglePlay release or release outside China market channel) <br /> libs/yumi_adapter_unity_v3.3.9_China.jar (China market channel release)|
| Provider Ver      | 2.3.0                       |
| GooglePlayService | Require                     |
| Ad Form           | Interstitial,Reward Video   |
| .so/lib project   | --                          |
