...
public class YumiUnityAdUtils
{
    ...
    public void AddBannerAd(string callbackName = "YumiAdHelp", Boolean isMatchWindowWidth = false)
    {
        ...
        if (string.IsNullOrEmpty(banner_slotID))
        {
            UnityEngine.Debug.LogError("banner_slotID is null");
            return;
        }
    ...
    public void InitInterstitialAd(string callbackName = "YumiAdHelp")
    {
        ...
        if (string.IsNullOrEmpty(interstitial_slotID))
        {
            UnityEngine.Debug.LogError("interstitial_slotID is null");
            return;
        }
        using (var jc = new AndroidJavaClass("com.zplay.adsyumi.unity.plugin.AdsPluginActivity"))
        {
    ...
    public void InitMedia(string callbackName = "YumiAdHelp")
    {
        ...
        if (string.IsNullOrEmpty(media_slotID))
        {
            UnityEngine.Debug.LogError("media_slotID is null");
            return;
        }
        using (var jc = new AndroidJavaClass("com.zplay.adsyumi.unity.plugin.AdsPluginActivity"))
        {
    ...
    /// </summary>
    public void IsMediaPrepared(string callbackName)
    {
        using (var jc = new AndroidJavaClass("com.zplay.adsyumi.unity.plugin.AdsPluginActivity"))
        {
            jc.CallStatic("IsMediaPrepared", ajo, callbackName);
        }
    }
    ...
    public interface InterstitialAdCallbackListener
    {
        ...
        void onInterstitialExposureFailed(string data);
    ...
    public interface MediaAdCallbackListener
    {
        ...
        void onIsMediaPrepared(string data);
    }
    #endregion
