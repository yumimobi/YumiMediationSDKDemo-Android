...
dependencies {
    ...
    implementation 'com.yumimobi.ads:mediation:4.6.1'
    ...
    implementation 'com.yumimobi.ads.mediation:inneractive:4.6.1'
    ...
    // compile 'com.yumimobi.ads.mediation:mintegral-china:4.6.1'
｝
```
